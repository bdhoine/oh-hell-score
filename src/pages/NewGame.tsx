...
import {ItemReorderEventDetail, SelectChangeEventDetail} from '@ionic/core';
    ...
    const openRenameDialog = (player: string, position: number) => {
        showRenameAlert({
            ...
            onDidPresent: (e) => {
                ...
                if (alert) {
                    let renameInput = alert.querySelector('#rename-player') as HTMLElement;
                    if (renameInput) {
                        renameInput.focus();
                    }
                }
                ...
                <IonList>
                    ...
                    <IonItem>
                        <IonInput
                            ...
                            onIonChange={e => setNewPlayer(e.detail.value!)}
