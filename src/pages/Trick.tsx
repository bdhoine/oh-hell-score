...
import {arrowForwardOutline, chevronBack, handLeft, refresh, trash} from 'ionicons/icons';
import {PlayerBet, Round} from '../@types/state';
        ...
        <IonPage className="oh-hell">
            ...
            <IonContent>
                        ...
                        {round.playerBets.map((bet, i) => {
                            return (
                                <IonItemSliding key={i}>
                                    ...
                                    <IonItemOptions side="start" onIonSwipe={() => {
                                    }}>
                ...
                <IonFab vertical="bottom" horizontal="end" slot="fixed">
                    <IonFabButton disabled={getTotalTrick() !== round.cards} mode="ios" className="floating-button" onClick={() => nextRound()}>
